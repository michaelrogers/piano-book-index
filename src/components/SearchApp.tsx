          ...
          >
            ...
            <div class="min-w-0 flex-1">
              ...
              <p class="truncate text-xs text-gray-500 dark:text-gray-400">
                {song.composer} · <a href={`/books/${song.bookId}`} class="underline decoration-gray-300 hover:text-piano-600 dark:decoration-gray-600 dark:hover:text-piano-400" onClick={(e) => e.stopPropagation()}>{song.bookTitle}</a>
